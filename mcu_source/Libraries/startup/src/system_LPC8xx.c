...
//  wdt_osc /= (((LPC_SYSCON->WDTOSCCTRL & 0x1F) + 1) << 1);
    ...
    switch (LPC_SYSCON->MAINCLKSEL & 0x03)
    {
        ...
        {
            case 0:
                SystemCoreClock = 9*1000*1000;
                break;
            case 1:
                SystemCoreClock = 12*1000*1000;
                break;
            case 2:
                SystemCoreClock = 15*1000*1000;
                break;
        }
          break;
    }
...
{
    /*
        00: 9 MHz clock output
        01: 12 MHz clock output
        10: 15 MHz clock output
    */
    LPC_SYSCON->FROOSCCTRL &= ~0x03;
    LPC_SYSCON->FROOSCCTRL |=  0x2;
