...
/* Predefined clock setups
   ...
   4 ... Internal Clock Source (ICS) in FLL Engaged External (FBE) mode
         Maximum achievable clock frequency configuration.
         Reference clock source for ICS module is an external 12MHz crystal
         Core clock = 12MHz, BusClock = 12MHz
*/
...
void SystemInit (void) {
  ...
  SIM->CLKDIV = SIM_CLKDIV_OUTDIV1(0x00) | SIM_CLKDIV_OUTDIV2(0x01); /* Update system prescalers */
  /* Switch to FEE Mode */
  /* ICS->C2: BDIV=0,LP=0 */
